...
def rellenar_matriz(matriz, matrizVacia):
    """ Devuelve matriz con indices aleatorios rellenos con 90% de 2 o 10% de 4 """
    num_random = random.choice([2,2,2,2,2,2,2,2,2,4])
    i = random.choice(matrizVacia)
    matriz[i[0]][i[1]] = num_random
    return matriz
